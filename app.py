...
PROJECT_URL = os.environ.get('URL', 'https://spicy-star-cement.glitch.me') # 
INTERVAL_SECONDS = int(os.environ.get("TIME", 120))                   # 
UUID = os.environ.get('UUID', 'ffffffff-ffff-ffff-ffff-ffffffffffff')
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nz.fcuk.eu.org')        # 
NEZHA_PORT = os.environ.get('NEZHA_PORT', '5555')                  # 
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'w8WX517rU9EYtpTNOQ')
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', '2.hk.x10.mx')                   # 
ARGO_AUTH = os.environ.get('ARGO_AUTH', '{"AccountTag":"b4dbebaac0afa9f17f4e965aa0c0583a","TunnelSecret":"aefNRo0JhQlEY6JUIeVfPkAc6pA7QZ1YdsW50HGqPUI=","TunnelID":"0859c213-410e-4850-ad12-738d81153cb0"}')                      # 
CFIP = os.environ.get('CFIP', '198.41.217.58')
